...
import com.v2solutions.taf.exception.TafDataProviderException;
import com.v2solutions.taf.util.ExcelUtil;
...
public class TafExcelDataProvider {
	...
	private static void readTestData(Class<?> callingTestClass) throws TafDataProviderException {
		...
		for(TestDataKey testDataKey:testKeyList){
			...
			Object[][] testDataChunk = ExcelUtil.readExcelData(filePath, testDataKey.getDataSheetName(), testDataKey.getDataKey());
