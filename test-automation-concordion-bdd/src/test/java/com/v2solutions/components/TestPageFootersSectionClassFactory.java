...
public class TestPageFootersSectionClassFactory 
{
	static test.v2solutions.components.TestPageFootersSection temp = new test.v2solutions.components.TestPageFootersSection();
