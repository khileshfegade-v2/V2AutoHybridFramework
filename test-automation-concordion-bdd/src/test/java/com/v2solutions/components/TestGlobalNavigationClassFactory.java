...
public class TestGlobalNavigationClassFactory 
{
	static test.v2solutions.components.TestGlobalNavigation temp = new test.v2solutions.components.TestGlobalNavigation();
